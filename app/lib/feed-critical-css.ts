...
.fh-content{background-color:#0d0d12;padding:var(--qvh-navbar-h,60px) 0 0;min-height:100vh;display:flex;flex-direction:column}
...
.fh-navbar-inner{display:flex;align-items:center;justify-content:space-between;width:100%;max-width:950px;margin:0 auto;padding:0 20px;gap:12px}
.fh-container{max-width:950px;margin:0 auto;padding:0 20px;width:100%;box-sizing:border-box}
.qvh-spotlight-visual{position:relative;height:132px;overflow:hidden;background:#101015}
