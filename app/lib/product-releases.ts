...
export const PRODUCT_RELEASES: ProductRelease[] = [
  {
    ...
    highlights: [
      "Séptimo sprint 30 ciclos · plataforma 4.20.0",
      "210 ciclos totales · v4 hubs centralizados",
      "299 tests · verify generatedAt",
    ],
  },
  {
    version: "4.10.0",
    date: "2026-06-11",
    title: "Verify generatedAt y E2E v4",
    highlights: [
      "verify-prod generatedAt ISO",
      "E2E health 4.x",
      "keep-warm-prod hubs ampliados",
    ],
  },
  {
    version: "4.00.0",
  ...
  },
  {
    ...
    highlights: [
      "Sexto sprint 30 ciclos · plataforma 3.90.0",
      "180 ciclos totales desde 2.13",
      "Explorar week+filtros · verify revalidate",
    ],
  },
  {
    version: "3.80.0",
  ...
  },
  {
    ...
    highlights: [
      "Explorar abre vista semanal con filtros",
      "Rollover laliga y warm formula-1",
      "Deep links centralizados en app móvil",
    ],
  },
  {
    version: "3.60.0",
    date: "2026-06-11",
    title: "Cierre maratón 3.31–3.60",
    highlights: [
      "Quinto sprint 30 ciclos · plataforma 3.60.0",
      "150 ciclos totales desde 2.13",
      "298 tests · week+filtros + warm hubs",
    ],
  },
  {
    version: "3.50.0",
    date: "2026-06-11",
    title: "E2E week+filtros y verify timezone",
    highlights: [
      "E2E week=1 preserva filtros",
      "verify-prod timezone Madrid",
      "Warm/rollover hubs alineados",
    ],
  },
  {
    version: "3.40.0",
    date: "2026-06-11",
    title: "Week+filtros y warm LaLiga",
    highlights: [
      "Deep link semana con filtros activos",
      "Rollover champions y warm laliga",
      "Docs gate PSI en desarrolladores",
    ],
  },
  {
    version: "3.30.0",
  ...
  },
  {
    ...
    highlights: [
      "E2E week=1 limpia URL",
      "verify-prod date Madrid",
      "Keep-warm /champions",
    ],
  },
  {
    version: "3.10.0",
    date: "2026-06-11",
    title: "Rollover hubs y docs widget",
    highlights: [
      "stripWeekViewFromSearch preserva filtros",
      "Rollover incluye hub fútbol y API week",
      "Docs widget next-favorite + export RGPD app",
    ],
  },
  {
    version: "3.00.0",
    date: "2026-06-11",
    title: "Cierre maratón 2.71–3.00",
    highlights: [
      "Tercer sprint 30 ciclos · plataforma 3.00.0",
      "Guía PERF gate + plan widget iOS",
      "293 tests · tres maratones completos",
    ],
  },
  {
    version: "2.90.0",
    date: "2026-06-11",
    title: "Sitemap, widget API y warm prod",
    highlights: [
      "Tests sitemap y widget 401",
      "keep-warm-prod API week",
      "E2E feed-meta todayCount",
    ],
  },
  {
    version: "2.80.0",
    date: "2026-06-11",
    title: "feed-meta testable y warm hubs",
    highlights: [
      "Payload feed-meta extraído y testeado",
      "HubWeekCtaLink + todayCount en frescura",
      "Keep-warm hub fútbol y API week",
    ],
  },
  {
    version: "2.70.0",
